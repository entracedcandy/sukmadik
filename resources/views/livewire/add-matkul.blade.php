            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form wire:submit.prevent="updateKampus">
                        <div class="mb-3">
                            <label for="nama_sesi" class="form-label">Nama Sesi</label>
                            <input type="text" wire:model.defer="EditNama" id="nama_sesi" class="form-control" placeholder="Masukkan nama sesi">
                            @error('EditNama') <small class="text-danger">{{ $message }}</small> @enderror
                        </div>
                         <div class="mb-3">
                            <label for="start" class="form-label">Jam Mulai</label>
                            <input type="time" wire:model.defer="EditStart" id="start" class="form-control">
                            @error('EditStart') <small class="text-danger">{{ $message }}</small> @enderror
                        </div>
                        <div class="mb-3">
                            <label for="End" class="form-label">Jam Mulai</label>
                            <input type="time" wire:model.defer="EditEnd" id="End" class="form-control">
                            @error('EditEnd') <small class="text-danger">{{ $message }}</small> @enderror
                        </div>
                        <div class="text-end">
                            <button type="submit" class="btn btn-success">Simpan</button>
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
